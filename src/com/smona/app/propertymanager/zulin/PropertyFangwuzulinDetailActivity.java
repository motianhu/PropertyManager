...
public class PropertyFangwuzulinDetailActivity extends BaseActivity {
    @Override
    ...
    protected void initBody() {
        ...
        initText(parent, R.id.name, R.string.property_fangwuzulin_item_yewuleixing);
        ...
        initText(parent, R.id.name, R.string.property_fangwuzulin_fangyuanfabu_peitaomiaoshu);
