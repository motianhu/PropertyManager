...
public class PropertyTousujianyiTable extends PropertyAbstractTable {
    ...
    private static volatile PropertyTousujianyiTable mInanstance = null;

    public PropertyTousujianyiTable(String tableName) {
        super(TABLE_NAME);
    }

    public synchronized static PropertyTousujianyiTable getInstance() {
        if (mInanstance == null) {
            mInanstance = new PropertyTousujianyiTable(TABLE_NAME);
        }
        return mInanstance;
    }
