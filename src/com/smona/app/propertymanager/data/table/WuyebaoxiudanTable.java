...
public class WuyebaoxiudanTable extends AbstractTable {
    ...
    private static volatile WuyebaoxiudanTable mInanstance = null;

    public WuyebaoxiudanTable(String tableName) {
        super(TABLE_NAME);
    }

    public synchronized static WuyebaoxiudanTable getInstance() {
        if (mInanstance == null) {
            mInanstance = new WuyebaoxiudanTable(TABLE_NAME);
        }
        return mInanstance;
    }
