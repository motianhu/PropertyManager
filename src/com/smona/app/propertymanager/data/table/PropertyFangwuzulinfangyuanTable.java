...
public class PropertyFangwuzulinfangyuanTable extends PropertyAbstractTable {
    ...
    private static volatile PropertyFangwuzulinfangyuanTable mInanstance = null;

    public PropertyFangwuzulinfangyuanTable(String tableName) {
        super(TABLE_NAME);
    }

    public synchronized static PropertyFangwuzulinfangyuanTable getInstance() {
        if (mInanstance == null) {
            mInanstance = new PropertyFangwuzulinfangyuanTable(TABLE_NAME);
        }
        return mInanstance;
    }
